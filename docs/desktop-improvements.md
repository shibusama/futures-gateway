...
| 功能 | 现状 | 工作量 | 建议优先级 |
|------|------|--------|------------|
| 启动闪屏 / Loading（「正在连接…」） | ❌ | 小～中 | ⭐⭐⭐ |
| 网关崩溃自动重启 | ❌ | 中 | ⭐⭐ |
| 端口被占用时的明确提示 | ⚠️ 可能连到别的进程 | 小 | ⭐⭐⭐ |
...
| 配置加密 | ❌ | 中 | ⭐ |
| 日志轮转 / 一键导出诊断 | ❌ 仅 gateway.log append | 小 | ⭐⭐ |
...
| exe 属性里的版本信息 | ⚠️ 弱 | 可嵌入 FileVersion、CompanyName |
